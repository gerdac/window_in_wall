...
1. Fork `the repository <https://github.com/augmentedfabricationlab/window_in_wall>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/window_in_wall/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/window_in_wall/issues>`_. If you are proposing a feature:
